...
function listarLivro(req, res) {
    avisoModel.listarLivro().then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function maisRecentes(req, res) {
    avisoModel.maisRecentes().then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function comentarios(req, res) {
    var idManga = req.params.idManga;
    avisoModel.comentarios(idManga).then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
